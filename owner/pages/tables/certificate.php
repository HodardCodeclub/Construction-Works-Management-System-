    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
          ESwahili App advanced users who have a certificate
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Advanced users</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
           ...
           $result=mysqli_query($conn,"SELECT * from users where email!='admin@gmail.com' and currentmarks>=80");
