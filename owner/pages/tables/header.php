    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="./addnew.php"><i class="fa fa-circle-o"></i>Add new word</a></li>
          <li><a href="./wordimages.php"><i class="fa fa-circle-o"></i> Words with images</a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="./newuser.php"><i class="fa fa-user"></i> Add new user</a></li>
          <li><a href="./users.php"><i class="fa fa-user"></i> All users</a></li>
          <li><a href="./certificate.php"><i class="fa fa-user"></i> Who have certificate</a></li>
        </ul>
      </li>

      <li class="treeview">
        <a href="../../support.php">
          <i class="fa fa-envelope"></i> <span>Support message</span>
