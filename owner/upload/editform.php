	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='../pages/tables/wordimages.php';
				</script>
                <?php
			}
			else{
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">update word. <a class="btn btn-success" href="../pages/tables/wordimages.php"> all words with images </a>
			<a class="btn btn-info" href="../pages/tables/wordnoimages.php"> all words with no images </a></h1>
    </div>
...
if($Pic ==''){
	...
	<tr>
		<td><label class="control-label"> Img.</label></td>
			<td>
				<p><img src="noimage.png" height="150" width="150" /></p>
				<input class="input-group" type="hidden" name="user_image" accept="image/*" />
			</td>
	</tr>
