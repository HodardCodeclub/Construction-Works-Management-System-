        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <a href="newvendor.php" class="btn btn-info">Create new vendor</a>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo"<td>" .$test['vaddress']."</font></td>";
            
             echo"<td>" .$test['contact']."</font></td>";
             echo"<td>" .$test['phone']."</font></td>";
             echo"<td>" .$test['vemail']."</font></td>";
             
             //echo"<td>" .$test['education']."</font></td>";
             //echo"<td>" .$test['martial']."</font></td>";
             echo"<td>" .$test['payment']."</font></td>";
             echo"<td>" .$test['bank']."</font></td>";
