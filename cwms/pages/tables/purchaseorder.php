        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <a href="newpurchaseorder.php" class="btn btn-info">Create new purchase order</a>
                <div class="box-header">
                  <h3 class="box-title">All purchase order</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <div id="printMe">
           ...
           $result=mysqli_query($conn,"SELECT * from purchaseorder");
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo "<tr align='center'>";
              ...
              echo"<td>" .$test['ordername']."</font></td>";
                   //  echo"<td>" .$test['dateofbirth']."</font></td>";
             echo"<td>" .$test['branch']."</font></td>";
            
             echo"<td>" .$test['project']."</font></td>";
             echo"<td>" .$test['vendor']."</font></td>";
             echo"<td>" .$test['packing']."</font></td>";
             echo"<td>" .$test['insurance']."</font></td>";
             //echo"<td>" .$test['martial']."</font></td>";
             echo"<td>" .$test['edate']."</font></td>";
             echo"<td>" .$test['adate']."</font></td>";
           ...
           ?>
                  ...
                  <?php
                    ...
                    if(isset($_GET['delete_id']))
                    {
                      ...
                      $result=mysqli_query($conn,"DELETE FROM purchaseorder where id ='$idd'");
