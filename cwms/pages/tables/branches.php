        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <a href="newbranch.php" class="btn btn-info">Create new branch</a>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo "<tr align=''>";
              ...
              echo"<td>" .$test['bname']."</font></td>";
                   //  echo"<td>" .$test['dateofbirth']."</font></td>";
             echo"<td>" .$test['bcode']."</font></td>";
           
             echo"<td>" .$test['baddress']."</font></td>";
             echo"<td>" .$test['bemail']."</font></td>";
             echo"<td>" .$test['mobilephone']."</font></td>";
             //echo"<td>" .$test['education']."</font></td>";
             //echo"<td>" .$test['martial']."</font></td>";
             echo"<td>" .$test['tin']."</font></td>";
            // echo"<td>" .$test['examdate']."</font></td>";
              ...
              <td><a href="../../upload/editformnoimage.php?edit_id=<?php echo $test['id']; ?>" title="click for edit" onclick="return confirm('sure to edit ?')" class='btn btn-success'>Update</a></td>
           ...
           ?>
                  ...
                  <?php
                    ...
                    if(isset($_GET['delete_id']))
                    {
                      ...
                      $result=mysqli_query($conn,"DELETE FROM branches where id ='$idd'");
