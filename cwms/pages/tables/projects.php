        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="box">
                <a href="newproject.php" class="btn btn-info">Create new project</a>
           ...
           while($test = mysqli_fetch_array($result))
           {
             ...
             echo "<tr align='center'>";
              ...
              echo"<td>" .$test['pname']."</font></td>";
                   //  echo"<td>" .$test['dateofbirth']."</font></td>";
             echo"<td>" .$test['email']."</font></td>";
            
             echo"<td>" .$test['siteaddress']."</font></td>";
             echo"<td>" .$test['homephone']."</font></td>";
             echo"<td>" .$test['sdate']."</font></td>";
                ...
                <a href="#" class="btn btn-success" onclick="printDiv('printMe')">Print This report</a>
                  ...
                  <?php
                    ...
                    if(isset($_GET['delete_id']))
                    {
                      ...
                      $result=mysqli_query($conn,"DELETE FROM projects where id ='$idd'");
